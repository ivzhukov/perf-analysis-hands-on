...
$ module use /jet/home/zhukov/ihpcss26/modules/
$ module load gcc/13.3.1-p20240614 openmpi/5.0.8-gcc13.3.1 scorep/10.0-gcc_openmpi scalasca/2.6.2-gcc_openmpi
```

Go to our work directory with already build executable and prepared filtering file 
```bash
$ cd $HOME/ihpcss26/NPB3.3-MZ-MPI/bin.scorep
```
...
```
S=C=A=N: Thu Jun 16 07:40:59 2026: Analyze start
/opt/packages/openmpi/5.0.8/gnu-13.3.1/bin/mpirun -n 8 --cpus-per-rank 6 /jet/home/zhukov/ihpcss26/tools/scalasca/2.6.2/gcc_openmpi/bin/scout.hyb ./scorep_bt-mz_C_8x6_trace/traces.otf2
...
S=C=A=N: Thu Jun 16 07:41:14 2026: Analyze done (status=0) 15s
```
